...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 m-b-20">
            <a class="btn btn-outline-dark btn-sm" href="/adm" role="button">Voltar</a>
        </div>
    </div>
                ...
                <div class="card border-dark">
                      ...
                      <form action="" method="post" enctype="multipart/form-data" class="was-validated">
                                    ...
                                    <div class="col-lg-5">
                                          ...
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <textarea id="text" name="text">{!!$banner1->text!!}</textarea>
                                              ...
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <div class="card border-secondary">
                                                      <div class="card-body">
                                                          ...
                                                          <input type="text" class="form-control form-control-sm" maxlength="240" placeholder="Legenda da banner principal" name="legendaBanner" value="{{$banner1->legenda_banner}}"> -->
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="form-group col-md-12">
                                                  <div class="form-row">
                                                      <div class="form-group col-md-12">
                                                          ...
                                                          <input type="text" class="form-control form-control-sm" id="inputLink" maxlength="240" placeholder="Link" name="link" value="{{$banner1->link}}" />
                                                      </div>
                                                  </div>
                          ...
                          <div class="card-footer text-muted">
                                <button type="submit" id="bt-cadastrar-editar" class="btn btn-outline-success btn-block">Atualizar Banner (1)</button>
                          </div>
                      </form>
