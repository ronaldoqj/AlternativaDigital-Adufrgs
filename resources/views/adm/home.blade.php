...
@endsection
@section('js')
    <script src="/js/pages/adm/banner1.js"></script>
@stop
@section('content')
                    ...
                    <div class="card border-dark">
                          ...
                          <form action="" method="post" enctype="multipart/form-data" class="was-validated">
                              ...
                              <div class="card-footer text-muted">
                                <button type="submit" id="bt-cadastrar-editar" class="btn btn-outline-success btn-block">Cadastrar Banner (1)</button>
                              </div>
                          </form>
    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="card bg-light">
                <div class="card-header">Listagem dos Banners (1)</div>
                <div class="card-body">
                      <!-- ==================================================================  -->
                      <!-- ======================== Itens listados =========================== -->
                      <!-- ==================================================================  -->

                      @forelse ($banner1 as $register)
                          <?php
                          ...
                          ?>
                          <form action="{{url("/adm/banner1-edit/{$register->id}")}}" method="get">
