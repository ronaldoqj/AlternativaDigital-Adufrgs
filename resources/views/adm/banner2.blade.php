...
@endsection
@section('js')
    <script src="/js/pages/adm/banner2.js"></script>
@stop
@section('content')
                    ...
                    <div class="card border-dark">
                          ...
                          <form action="" method="post" enctype="multipart/form-data" class="was-validated">
                              ...
                              <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                              ...
                                              <div class="form-row">
                                                  <div class="form-group col-md-12">
                                                      <label for="inputTelefone">Link:</label>
                                                      <input type="text" class="form-control form-control-sm" id="inputSite" maxlength="240" placeholder="Link" name="link" />
                                                  </div>
                                              </div>
                              ...
                              <div class="card-footer text-muted">
                                <button type="submit" id="bt-cadastrar-editar" class="btn btn-outline-success btn-block">Cadastrar Banner (2)</button>
                              </div>
                          </form>
    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="card bg-light">
                <div class="card-header">Listagem dos Banners (2)</div>
                <div class="card-body">
                      <!-- ==================================================================  -->
                      <!-- ======================== Itens listados =========================== -->
                      <!-- ==================================================================  -->

                      @forelse ($banner2 as $register)
                          <?php
                              $img = 'images/default.png';
                              $img = $register->image_namefilefullthumb ? $register->image_namefilefullthumb : $img;
                              $imgGrande = $img;
                              $imgGrande = $register->image_namefilefull ? $register->image_namefilefull : $img;
                          ...
                          ?>
                          <form action="{{url("/adm/banner2-edit/{$register->id}")}}" method="get">
                              <div class="card border-secondary">
                                <div class="card-body text-secondary">
                                  <div class="imagesList" rel="/{{$imgGrande}}" style="background-image: url(/{{$img}});"></div>
                                      ...
                                      <div class="texts-listagem">{!!$register->text!!}</div>
                                </div>
                              </div>
                          </form>
                      @empty
                          <p>Nenhuma banner cadastrado no momento.</p>
                      @endforelse
                      <!-- ==================================================================  -->
                      <!-- ======================== Itens listados =========================== -->
                      <!-- ==================================================================  -->
  ...
  <div id="edit" class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Imagem do Banner</h5>
