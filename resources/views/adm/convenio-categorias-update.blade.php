<?php
    $convenioCategoria = $return['convenio-categoria'];
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 m-b-20">
            <a class="btn btn-outline-dark btn-sm" href="/adm/convenio/categorias" role="button">Voltar</a>
        </div>
    </div>
        ...
        <div class="col-md-12 m-b-20">
                <div class="card border-dark">
                      ...
                      <form action="" method="post" enctype="multipart/form-data" class="was-validated">
                          ...
                          <input type="hidden" name="id" value="{{$convenioCategoria->id}}" />
                          <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="inputName" maxlength="240" placeholder="Nome da Categoria" name="name" value="{{$convenioCategoria->name}}" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                                      ...
                                                      <div class="card-body">
                                                          <?php
                                                              ...
                                                              if($image)
                                                              {
                                                                  ...
                                                                  $imageId = $image->id;
                                                                  $img = $image->image_namefilefull ? $image->image_namefilefull : $img;
                                                                  $imgGrande = $img;
                                                              }
                                                          ?>
                                                          <img src="/{{$img}}" rel="/{{$imgGrande}}" class="rounded mx-auto d-block imagesList" width="116" alt="" />
                          ...
                          <div class="card-footer text-muted">
                                <button type="submit" id="bt-cadastrar-editar" class="btn btn-outline-success btn-block">Atualizar Categoria</button>
                          </div>
                      </form>
