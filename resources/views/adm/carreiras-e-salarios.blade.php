<?php
    $register = $return['carreiraSalario'];
...
@endsection
@section('js')
    <script src="/js/pages/adm/carreira-e-salario.js"></script>
@stop
@section('content')
                                    ...
                                    <div class="card border-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                // });
                                                // CKEDITOR.replace( 'text', {
                                                //     filebrowserBrowseUrl: '/plugins-frameworks/ckeditor/plugins/imageuploader',
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="card border-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                              <div class="form-group col-md-12">
                                                <label for="inputDescritivo">Descrição:</label>
                                                <textarea id="inputDescritivo" name="descritivo">{!!$register->descritivo!!}</textarea>
                                                <script type="text/javascript">
                                                CKEDITOR.replace( 'inputDescritivo' );
                                                </script>
                                              </div>
                                            </div>
                                        </div>
