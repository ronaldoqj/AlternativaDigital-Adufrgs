                    ...
                    <div class="card border-dark">
                          ...
                          <form action="" method="post" enctype="multipart/form-data" class="was-validated">
                                        ...
                                        <div class="col-lg-6">
                                              ...
                                              <div class="form-row">
                                                  <div class="form-group col-md-12">
                                                      ...
                                                      <input type="text" class="form-control form-control-sm" id="inputProfession" maxlength="240" placeholder="Profissão" name="profession" />
                                                  </div>
                                              </div>
                              ...
                              <div class="card-footer text-muted">
                                <button type="submit" id="bt-cadastrar-editar" class="btn btn-outline-success btn-block">Cadastrar Autor</button>
                              </div>
                          </form>
    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="card bg-light">
                <div class="card-header">Listagem dos Autores</div>
                <div class="card-body">
                      <!-- ==================================================================  -->
                      <!-- ======================== Itens listados =========================== -->
                      <!-- ==================================================================  -->

                      @forelse ($docenteAutor as $register)
                          <?php
                          ...
                          ?>
                          <form action="{{url("/adm/docente/autor-edit/{$register->id}")}}" method="get">
                      ...
                      @empty
                          <p>Nenhuma autor cadastrado no momento.</p>
                      @endforelse
                      <!-- ==================================================================  -->
                      <!-- ======================== Itens listados =========================== -->
                      <!-- ==================================================================  -->
