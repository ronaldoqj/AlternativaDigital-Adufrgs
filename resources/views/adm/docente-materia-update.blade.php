...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 m-b-20">
            <a class="btn btn-outline-dark btn-sm" href="/adm/docente/materia" role="button">Voltar</a>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                              ...
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <select id="selectAutor" name="autor" class="selectpicker is-valid" data-actions-box="true" data-width="100%" title="Selecione o Autor">
                                                      ...
                                                      @foreach( $autores as $autor )
                                                          ...
                                                          ?>
                                                          <option {{$selected}}  value="{{$autor->id}}" data-content="<img src='{{$img}}' height='25' alt='{{$autor->name}}'> {{str_limit($autor->name, 30, '...')}}">{{str_limit($autor->name, 30, '...')}}</option>
                                                      @endforeach
                                                  </select>
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <input type="text" class="form-control form-control-sm" id="inputAssunto" maxlength="240" placeholder="Assunto" name="assunto" value="{{$noticia->assunto}}" />
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  <label for="inputTitle">Título:*</label>
                                                  <input type="text" class="form-control form-control-sm" id="inputTitle" maxlength="240" placeholder="Título" name="title" value="{{$noticia->title}}" required />
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  <label for="inputSub_title">Sub-titulo:*</label>
                                                  <input type="text" class="form-control form-control-sm" id="inputSub_title" maxlength="240" placeholder="Sub-titulo" name="subtitle" value="{{$noticia->subtitle}}" />
                                              </div>
                                          </div>
                                          <?php
                                          /*
                                          ...
                                          */ ?>
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  <label for="inputTextos">Texto 1:</label>
                                          ...
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  <label for="inputTextos2">Texto 2:</label>
                                    ...
                                    <div class="col-lg-6">
                                          ...
                                          <div class="form-row">
                                              ...
                                              <div class="form-group col-md-10">
                                                  <input type="text" class="form-control form-control-sm" id="inputFlickr" maxlength="240" placeholder="Flickr" name="flickr" value="{{$noticia->flickr}}">
                                              </div>
                                          </div>
                                          */ ?>
                                    </div>
