...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 m-b-20">
            <a class="btn btn-outline-dark btn-sm" href="/adm/banner2" role="button">Voltar</a>
        </div>
    </div>
                                    ...
                                    <div class="col-lg-5">
                                          ...
                                          <div class="form-row">
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <textarea id="text" name="text">{!!$banner2->text!!}</textarea>
                                              ...
                                              <div class="form-group col-md-12">
                                                  ...
                                                  <div class="card border-secondary">
                                                      <div class="card-body">
                                                          ...
                                                          <input type="text" class="form-control form-control-sm" maxlength="240" placeholder="Legenda da banner principal" name="legendaBanner" value="{{$banner2->legenda_banner}}"> -->
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="form-group col-md-12">
                                                  <div class="form-row">
                                                      <div class="form-group col-md-12">
                                                          ...
                                                          <input type="text" class="form-control form-control-sm" id="inputLink" maxlength="240" placeholder="Link" name="link" value="{{$banner2->link}}" />
                                                      </div>
                                                  </div>
